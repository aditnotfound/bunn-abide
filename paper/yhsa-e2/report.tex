...
\newcommand{\draftnote}{\textbf{Completed evidence draft.} This version reports the frozen ABIDE-I operator study, the audited post-hoc checkpoint intervention analysis, and a separately labelled synthetic known-geometry study. External validation and additional architecture studies are not presented as completed results.}
...
\hline
Report Version & Completed evidence report with E1 and E2 mechanism studies, 14 August 2026 \\
\hline
\end{tabularx}
...
must independently revise the prose, complete the acknowledgments,
verify all personal details, and sign the integrity commitments.
\end{minipage}
\clearpage
...
\begin{enumerate}[label=\arabic*.,leftmargin=2.2em]
  ...
  \item All external assistance must be disclosed in
...
The current source code, report source, and manifests are stored in
