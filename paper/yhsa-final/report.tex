...
known. Deeper matched GCN/BuNN networks, a leakage-free Wang-style time-series
model, and prospective ABIDE-II evaluation remain separate studies. E3 is only
warranted if the paper needs to answer a remaining depth/capacity question; it
is not needed to establish the conditional E2 mechanism.
